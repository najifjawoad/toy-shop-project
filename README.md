...
react-router : 	Routing logic for navigation
react-router-dom : 	DOM bindings for React Router
react-helmet-async : 	Manage document head (title, meta tags) dynamically
react-icons :	Icon library for React (FontAwesome, Material, etc.)
react-toastify	: Toast notifications for user feedback
toastify	: Lightweight toast notification alternative
firebase	: Authentication, database, and hosting
tailwindcss : 	Utility-first CSS framework
@tailwindcss/vite : 	Tailwind plugin for Vite integration
daisyui : 	Tailwind component library for UI elements
aos : 	Animate On Scroll – adds scroll animationsv
